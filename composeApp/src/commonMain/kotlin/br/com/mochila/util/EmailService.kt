...
object EmailService {
    ...
    private fun buildVerificationHtml(code: String) =
        """<!DOCTYPE html><html><body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;"><h2 style="color:#E91E8C;">Mochila Hub</h2><p>Obrigado por se cadastrar! Para ativar sua conta, use o código abaixo:</p><div style="background:#FFF0F6;border-radius:8px;padding:24px;text-align:center;margin:24px 0;"><span style="font-size:36px;font-weight:bold;letter-spacing:12px;color:#E91E8C;">$code</span></div><p>Este código é válido por <strong>15 minutos</strong>.</p><p>Se você não criou uma conta no Mochila Hub, ignore este e-mail.</p><hr style="border:none;border-top:1px solid #eee;margin:24px 0;"><p style="color:#888;font-size:12px;">Equipe Mochila Hub</p></body></html>"""

    private fun buildRecoveryHtml(code: String) =
        """<!DOCTYPE html><html><body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;"><h2 style="color:#E91E8C;">Mochila Hub</h2><p>Recebemos uma solicitação de recuperação de senha para a sua conta.</p><p>Use o código abaixo para redefinir sua senha:</p><div style="background:#FFF0F6;border-radius:8px;padding:24px;text-align:center;margin:24px 0;"><span style="font-size:36px;font-weight:bold;letter-spacing:12px;color:#E91E8C;">$code</span></div><p>Este código é válido por <strong>15 minutos</strong>.</p><p>Se você não solicitou a recuperação de senha, ignore este e-mail.</p><hr style="border:none;border-top:1px solid #eee;margin:24px 0;"><p style="color:#888;font-size:12px;">Equipe Mochila Hub</p></body></html>"""
